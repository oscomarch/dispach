...
export default function NewFlowPage() {
  ...
  const otherMembers = mockProfiles.filter((p) => p.id !== currentUser.id);
  ...
  const handleSubmit = async () => {
    setLoading(true);
    // In production, this would create the flow in Supabase
    ...
    <div className="max-w-[880px] mx-auto px-8 py-8">
      ...
      <section className="mb-10">
        <div className="flex items-center gap-3 mb-5">
          <span
            className="flex items-center justify-center w-6 h-6 rounded-full bg-accent text-white text-xs font-bold"
          >
            1
          </span>
